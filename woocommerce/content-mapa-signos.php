...
<!-- Map Container -->
<div class="map-container" id="signos-map-page">
  ...
  <div id="preview">
    ...
    <div id="mapSnapshotBlock">
      <div id="mapSnapshot">
        ...
        <div class="map-content planet-map signos-map -custom2 -bg-stars" data-bg="dark" id="mapContent">
          ...
          <div id="map-planet-simulator">
            <img class="" src="<?php echo $template_dir ?>/assets/images/signos/constelacao-capricornio-white.png" />
          </div>
  ...
  <div id="control-panel" data-active="1">
    ...
    <div class="control-panel-menu">
      ...
      <button class="control-panel-trigger hidden" data-target="2">Momento</button>
    ...
    <div class="control-panel-items">
      ...
      <div class="item" id="step1">
        ...
        <div class="item-block">
          ...
          <div class="label-group label-stile-group label-group--3">
            ...
            <input name="estilo" type="radio" id="estilo-simbolo" value="simbolo" />
            <label for="estilo-simbolo">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-leao-black.png" alt="Símbolo" />
            </label>
          </div>
        </div>

        <!-- Item Block -->
        <div class="item-block ilustration-section" data-ilustration="constelacao">
          ...
          <div class="label-group ilustration-group label-group--4 -ilustration-simbolo">
            ...
            <label for="ilustration-simbolo-capricornio">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-capricornio-black.png" alt="Símbolo" />
              <p>Capricórnio</p>
            ...
            <label for="ilustration-simbolo-aquario">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-aquario-black.png" alt="Símbolo" />
              <p>Aquário</p>
            ...
            <label for="ilustration-simbolo-peixes">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-peixes-black.png" alt="Símbolo" />
              <p>Peixes</p>
            ...
            <label for="ilustration-simbolo-aries">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-aries-black.png" alt="Símbolo" />
              <p>Áries</p>
            ...
            <label for="ilustration-simbolo-touro">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-touro-black.png" alt="Símbolo" />
              <p>Touro</p>
            ...
            <label for="ilustration-simbolo-gemeos">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-gemeos-black.png" alt="Símbolo" />
              <p>Gêmeos</p>
            ...
            <label for="ilustration-simbolo-cancer">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-cancer-black.png" alt="Símbolo" />
              <p>Câncer</p>
            ...
            <label for="ilustration-simbolo-virgem">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-virgem-black.png" alt="Símbolo" />
              <p>Virgem</p>
            ...
            <label for="ilustration-simbolo-libra">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-libra-black.png" alt="Símbolo" />
              <p>Libra</p>
            ...
            <label for="ilustration-simbolo-escorpiao">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-escorpiao-black.png" alt="Símbolo" />
              <p>Escorpião</p>
            ...
            <label for="ilustration-simbolo-sagitario">
              <img class="" src="<?php echo $template_dir; ?>/assets/images/signos/simbolo-sagitario-black.png" alt="Símbolo" />
              <p>Sagitário</p>
        ...
        <div class="item-block">
          ...
          <div class="label-group label-group--4 custom-label-colors" style="flex-wrap:wrap;">
            <input type="radio" name="map-color" value="asphalt" data-bg-color="182831" data-image-color="white" id="map-color-asphalt" checked autocomplete="off">
            <label class="map-color-item" for="map-color-asphalt" style="background: url(<?php echo $template_dir; ?>/assets/images/icon-asphalt.png)"></label>

            <input type="radio" name="map-color" value="nautical" data-bg-color="FDF7EF" data-image-color="nautical" id="map-color-nautical" autocomplete="off">
            <label class="map-color-item" for="map-color-nautical" style="background: url(<?php echo $template_dir; ?>/assets/images/icon-nautical.png)"></label>

            <input type="radio" name="map-color" value="modern" data-bg-color="FFFFFF" data-image-color="black" id="map-color-modern" autocomplete="off">
            <label class="map-color-item" for="map-color-modern" style="background: url(<?php echo $template_dir; ?>/assets/images/icon-modern.png)"></label>

            <input type="radio" name="map-color" value="cloud" data-bg-color="A1AEB8" data-image-color="cloud" id="map-color-cloud" autocomplete="off">
            <label class="map-color-item" for="map-color-cloud" style="background: url(<?php echo $template_dir; ?>/assets/images/icon-cloud.png)"></label>

            <input type="radio" name="map-color" value="bright" data-bg-color="FFFFFF" data-image-color="white" id="map-color-bright" autocomplete="off">
            <label class="map-color-item" for="map-color-bright" style="background: url(<?php echo $template_dir; ?>/assets/images/icon-bright.png)"></label>

            <input type="radio" name="map-color" value="dark" data-bg-color="222222" data-image-color="white" id="map-color-dark" autocomplete="off">
            <label class="map-color-item" for="map-color-dark" style="background: url(<?php echo $template_dir; ?>/assets/images/icon-dark.png)"></label>

            <input type="radio" name="map-color" value="gaia" data-bg-color="F9F1E7" data-image-color="white" id="map-color-gaia" autocomplete="off">
            <label class="map-color-item" for="map-color-gaia" style="background: url(<?php echo $template_dir; ?>/assets/images/icon-gaia.png)"></label>
          </div>
      ...
      <!-- Item -->
      <div class="item hidden" id="step2">
