...
<!-- Map Container -->
<div class="map-container" id="custom-map-page">
  ...
  <div id="preview">
    ...
    <div id="mapSnapshotBlock">
      <div id="mapSnapshot">
        ...
        <div class="map-content planet-map -custom2" id="mapContent">
          <p class="placeholder-info">Imagem Ilustrativa</p>
          <div class="map-content-scaled" data-color="black">
            <img class="svg" src="<?php echo $custom_map_images['images'][0]['image']['url']; ?>" />
          </div>
          <div class="map-text">
    ...
    <div class="control-panel-items">
      ...
      <div class="item" id="step1">
        ...
        <div class="item-block">
          ...
          <div class="label-group ilustration-group label-group--3">
            <?php foreach($custom_map_images['images'] as $key => $image) : ?>
              <input name="ilustration" type="radio" id="ilustration<?php echo $key; ?>" <?php echo !$key ? 'checked' : ''; ?>/>
              <label for="ilustration<?php echo $key; ?>">
                <img class="svg" src="<?php echo $image['image']['url']; ?>" alt="Ilustração <?php echo $key; ?>" />
              </label>
            <?php endforeach; ?>
          </div>
        </div>
      ...
      <div class="item" id="step3">
        ...
        <div class="item-block border-type-block">
          ...
          <div class="label-group label-group--3">
            <input type="radio" name="map-frame-color" value="Preto" id="map-frame-black" checked>
            ...
            <input type="radio" name="map-frame-color" value="Branco" id="map-frame-white">
            <label class="map-frame-color-item map-frame-color-item--white" for="map-frame-white" style="background: #fff">Branca</label>

            <!-- <input type="radio" name="map-frame-color" value="Madeira" id="map-frame-wood">
            <label class="map-frame-color-item map-frame-color-item--wood" for="map-frame-wood" style="background: #9a7348; color: #fff;">Madeira</label> -->
          </div>
        </div>
        <!-- Item Block -->
