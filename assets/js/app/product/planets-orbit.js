// Posicionamento do sol - linha 656
// 2.01 - zoomOffSetX, canvas.height / 1.96
...
var planetMercuryColor = 'rgb(215, 184, 137)',
  planetVenusColor = 'rgb(237, 107, 6)',
  planetEarthColor = 'rgb(65, 192, 240)',
  planetMarsColor = 'rgb(200, 21, 23)',
  planetJupiterColor = 'rgb(241, 152, 130)',
  planetSaturnColor = 'rgb(179, 128, 65)',
  planetUranusColor = 'rgb(0, 157, 180)',
  planetNeptuneColor = 'rgb(13, 98, 170)',
  sunColor = 'rgb(255, 224, 0)';
// var planetMercuryColor =  'transparent',
//   planetVenusColor =  'transparent',
//   planetEarthColor =  'transparent',
//   planetMarsColor =  'transparent',
//   planetJupiterColor =  'transparent',
//   planetSaturnColor =  'transparent',
//   planetUranusColor =  'transparent',
//   planetNeptuneColor =  'transparent',
//   sunColor = '#c9c9c9';

// planet sizes
var planetMercurySize = 5000,
  planetVenusSize = 8000,
  planetEarthSize = 13000,
  planetMarsSize = 10000,
  planetJupiterSize = 20000,
  planetSaturnSize = 11000,
  planetUranusSize = 15000,
  planetNeptuneSize = 10000,
  sunSize = 13;
  ...
  switch (context.clearRect(0, 0, canvas.width, canvas.height), planetScaleAdjustment = (planetSizeAdjust = zoomedinscale / scale) * 1500, planetScaleAdjustment += 870 * (zoomratio = (3e3 - planetScaleAdjustment) / 1500), currentView) {
    case TOPVIEW:
      zoomedoutscale < scale && scale < zoomedinscale && (orbitDashedColor = mobileDevice ? (orbitPointColor = orbitColor = "dimgrey", "lightgray") : (orbitPointColor = orbitColor = "#282828", "#646464"),
        ...
        renderPoint(orreryWidth / 2 + XMercury * scale - zoomOffSetX, canvas.height / 2 - YMercury * scale - zoomOffSetY, (1 + planetMercurySize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetMercuryColor, "SaddleBrown", context), 175 < scale && renderText("M", "Arial", "center", orreryWidth / 2 + XMercury * scale - zoomOffSetX, canvas.height / 2 - YMercury * scale + 4 - zoomOffSetY, 9 / planetSizeAdjust, "black", context), 100 <= scale && renderAxisRot(orreryWidth / 2 + XVenus * scale - zoomOffSetX, canvas.height / 2 - YVenus * scale - zoomOffSetY, "transparent", 250, -90, !1, (10 + 12104 / planetScaleAdjustment * .5) / planetSizeAdjust, context),
        renderPoint(orreryWidth / 2 + XVenus * scale - zoomOffSetX, canvas.height / 2 - YVenus * scale - zoomOffSetY, (1 + planetVenusSize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetVenusColor, "Peru", context), 175 < scale && renderText("V", "Arial", "center", orreryWidth / 2 + XVenus * scale - zoomOffSetX, canvas.height / 2 - YVenus * scale + 4 - zoomOffSetY, 9, "black", context), 100 <= scale && renderAxisRot(orreryWidth / 2 + XEarth * scale - zoomOffSetX, canvas.height / 2 - YEarth * scale - zoomOffSetY, "transparent", 90, -250, !0, (10 + 12756 / planetScaleAdjustment * .5) / planetSizeAdjust, context),
        renderPoint(orreryWidth / 2 + XEarth * scale - zoomOffSetX, canvas.height / 2 - YEarth * scale - zoomOffSetY, (1 + planetEarthSize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetEarthColor, "MidnightBlue", context), 175 < scale && renderText("E", "Arial", "center", orreryWidth / 2 + XEarth * scale - zoomOffSetX, canvas.height / 2 - YEarth * scale + 4 - zoomOffSetY, 9, "black", context), 100 <= scale && renderAxisRot(orreryWidth / 2 + XMars * scale - zoomOffSetX, canvas.height / 2 - YMars * scale - zoomOffSetY, "transparent", 90, -250, !0, (10 + 6792 / planetScaleAdjustment * .5) / planetSizeAdjust, context),
        renderPoint(orreryWidth / 2 + XMars * scale - zoomOffSetX, canvas.height / 2 - YMars * scale - zoomOffSetY, (1 + planetMarsSize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetMarsColor, "DarkRed", context), 175 < scale && renderText("M", "Arial", "center", orreryWidth / 2 + XMars * scale - zoomOffSetX, canvas.height / 2 - YMars * scale + 4 - zoomOffSetY, 9, "black", context), 100 <= scale && renderAxisRot(orreryWidth / 2 + XJupiter * scale / jupiterScaleDivider - zoomOffSetX, canvas.height / 2 - YJupiter * scale / jupiterScaleDivider - zoomOffSetY, "transparent", 90, -250, !0, (10 + 142984 / planetScaleAdjustment * .5) / planetSizeAdjust, context),
        renderPoint(orreryWidth / 2 + XJupiter * scale / jupiterScaleDivider - zoomOffSetX, canvas.height / 2 - YJupiter * scale / jupiterScaleDivider - zoomOffSetY, (1 + planetJupiterSize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetJupiterColor, "Chocolate", context), 100 <= scale && renderText("J", "Arial", "center", orreryWidth / 2 + XJupiter * scale / jupiterScaleDivider - zoomOffSetX, canvas.height / 2 - YJupiter * scale / jupiterScaleDivider + 4 - zoomOffSetY, 9, "black", context), 100 <= scale && renderAxisRot(orreryWidth / 2 + XSaturn * scale / saturnScaleDivider - zoomOffSetX, canvas.height / 2 - YSaturn * scale / saturnScaleDivider - zoomOffSetY, "transparent", 90, -250, !0, (10 + 120536 / planetScaleAdjustment * .5) / planetSizeAdjust, context),
        renderPoint(orreryWidth / 2 + XSaturn * scale / saturnScaleDivider - zoomOffSetX, canvas.height / 2 - YSaturn * scale / saturnScaleDivider - zoomOffSetY, (1 + planetSaturnSize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetSaturnColor, "PowderBlue", context), 100 <= scale && renderText("S", "Arial", "center", orreryWidth / 2 + XSaturn * scale / saturnScaleDivider - zoomOffSetX, canvas.height / 2 - YSaturn * scale / saturnScaleDivider + 4 - zoomOffSetY, 9, "black", context), 100 <= scale && renderAxisRot(orreryWidth / 2 + XUranus * scale / uranusScaleDivider - zoomOffSetX, canvas.height / 2 - YUranus * scale / uranusScaleDivider - zoomOffSetY, "transparent", 250, -90, !1, (10 + 51118 / planetScaleAdjustment * .5) / planetSizeAdjust, context),
        renderPoint(orreryWidth / 2 + XUranus * scale / uranusScaleDivider - zoomOffSetX, canvas.height / 2 - YUranus * scale / uranusScaleDivider - zoomOffSetY, (1 + planetUranusSize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetUranusColor, "DodgerBlue", context), 100 <= scale && renderText("U", "Arial", "center", orreryWidth / 2 + XUranus * scale / uranusScaleDivider - zoomOffSetX, canvas.height / 2 - YUranus * scale / uranusScaleDivider + 4 - zoomOffSetY, 9, "black", context), 100 <= scale && renderAxisRot(orreryWidth / 2 + XNeptune * scale / neptuneScaleDivider - zoomOffSetX, canvas.height / 2 - YNeptune * scale / neptuneScaleDivider - zoomOffSetY, "transparent", 90, -250, !0, (10 + 49528 / planetScaleAdjustment * .5) / planetSizeAdjust, context),
        renderPoint(orreryWidth / 2 + XNeptune * scale / neptuneScaleDivider - zoomOffSetX, canvas.height / 2 - YNeptune * scale / neptuneScaleDivider - zoomOffSetY, (1 + planetNeptuneSize / planetScaleAdjustment * .5) / planetSizeAdjust, 0, 2 * Math.PI, !0, planetNeptuneColor, "DodgerBlue", context), 100 <= scale && renderText("N", "Arial", "center", orreryWidth / 2 + XNeptune * scale / neptuneScaleDivider - zoomOffSetX, canvas.height / 2 - YNeptune * scale / neptuneScaleDivider + 4 - zoomOffSetY, 9, "black", context),
        renderPoint(orreryWidth / 2.01 - zoomOffSetX, canvas.height / 1.96 - zoomOffSetY, sunSize / planetSizeAdjust, 0, 2 * Math.PI, !0, sunColor, "orange", context), 100 <= scale && renderAxisRot(orreryWidth / 2 - zoomOffSetX, canvas.height / 2 - zoomOffSetY, "transparent", 90, -250, !0, 15 / planetSizeAdjust, context),
